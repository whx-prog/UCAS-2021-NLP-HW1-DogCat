...
def train():
    ...
    for epoch in range(Epoch):
        ...
        train_loss_list.append(train_loss.cpu().numpy().item())
        val_loss_list.append(val_loss.cpu().numpy().item())
        train_accuracy_list.append(train_acc.cpu().numpy().item())
        val_accuracy_list.append(val_acc.cpu().numpy().item())
